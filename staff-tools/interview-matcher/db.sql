...
CREATE TABLE feedback_for_fellow (
	...
	q_speaks_professionally VARCHAR(20) NOT NULL,
	q_eye_contact VARCHAR(20) NOT NULL,
	q_solid_handshake VARCHAR(20) NOT NULL,
	q_body_language VARCHAR(20) NOT NULL,
	q_specific_examples VARCHAR(20) NOT NULL,
	q_transferable_skills VARCHAR(20) NOT NULL,
	q_clear_concise VARCHAR(20) NOT NULL,
	q_compelling_storytelling VARCHAR(20) NOT NULL,
	q_confidently_persists VARCHAR(20) NOT NULL,
	q_personal_connection VARCHAR(20) NOT NULL,
	q_continue_connection VARCHAR(20) NOT NULL,
	q_prepared_questions VARCHAR(20) NOT NULL,
