<?php
	...
	$statement = $pdo->prepare("
		SELECT
			...
			feedback_for_fellow.q_speaks_professionally,
			feedback_for_fellow.q_eye_contact,
			feedback_for_fellow.q_solid_handshake,
			feedback_for_fellow.q_body_language,
			feedback_for_fellow.q_specific_examples,
			feedback_for_fellow.q_transferable_skills,
			feedback_for_fellow.q_clear_concise,
			feedback_for_fellow.q_compelling_storytelling,
			feedback_for_fellow.q_confidently_persists,
			feedback_for_fellow.q_personal_connection,
			feedback_for_fellow.q_continue_connection,
			feedback_for_fellow.q_prepared_questions,
